! function(t) {
	...
	var i, s, r, n, h, a, o, l, u, c, d, g, p, m, f, w = !1;
	...
	function v() {
		if (!w) {
			...
			if (g = /\b(iPhone|iP[ao]d)/.exec(t), p = /\b(iP[ao]d)/.exec(t), c = /Android/i.exec(t), m = /FBAN\/\w+;/i.exec(t), f = /Mobile/i.exec(t), d = !!/Win64/.exec(t), e) {
				...
				a = x ? parseFloat(x[1]) + 4 : i, s = e[2] ? parseFloat(e[2]) : NaN, r = e[3] ? parseFloat(e[3]) : NaN, (n = e[4] ? parseFloat(e[4]) : NaN) ? (e = /(?:Chrome\/(\d+\.\d+))/.exec(t), h = e && e[1] ? parseFloat(e[1]) : NaN) : h = NaN
			} else i = s = r = h = n = NaN;
			if (v) {
				if (v[1]) {
	...
	class f {
		constructor({
			...
			this.dpr = s, this.alpha = r, this.color = !0, this.depth = n, this.stencil = h, this.premultipliedAlpha = o, this.autoClear = c, this.id = m++, 2 === d && (this.gl = t.getContext("webgl2", g)), this.isWebgl2 = !!this.gl, this.gl || (this.gl = t.getContext("webgl", g) || t.getContext("experimental-webgl", g)), this.gl.renderer = this, this.setSize(e, i), this.state = {}, this.state.blendFunc = {
				src: this.gl.ONE,
				dst: this.gl.ZERO
		...
		getRenderList({
			...
			if (e && i && e.updateFrustum(), t.traverse(t => {
				...
				const t = [],
					...
					s = [];
				r.forEach(r => {
					r.program.transparent ? r.program.depthTest ? i.push(r) : s.push(r) : t.push(r), r.zDepth = 0, 0 === r.renderOrder && r.program.depthTest && e && (r.worldMatrix.getTranslation(p), p.applyMatrix4(e.projectionViewMatrix), r.zDepth = p.z)
		...
		fromEuler(t) {
			return function(t, e, i = "YXZ") {
				let s = Math.sin(.5 * e[0]),
					...
					a = Math.sin(.5 * e[2]),
					o = Math.cos(.5 * e[2]);
				"XYZ" === i ? (t[0] = s * h * o + r * n * a, t[1] = r * n * o - s * h * a, t[2] = r * h * a + s * n * o, t[3] = r * h * o - s * n * a) : "YXZ" === i ? (t[0] = s * h * o + r * n * a, t[1] = r * n * o - s * h * a, t[2] = r * h * a - s * n * o, t[3] = r * h * o + s * n * a) : "ZXY" === i ? (t[0] = s * h * o - r * n * a, t[1] = r * n * o + s * h * a, t[2] = r * h * a + s * n * o, t[3] = r * h * o - s * n * a) : "ZYX" === i ? (t[0] = s * h * o - r * n * a, t[1] = r * n * o + s * h * a, t[2] = r * h * a - s * n * o, t[3] = r * h * o + s * n * a) : "YZX" === i ? (t[0] = s * h * o + r * n * a, t[1] = r * n * o + s * h * a, t[2] = r * h * a - s * n * o, t[3] = r * h * o - s * n * a) : "XZY" === i && (t[0] = s * h * o - r * n * a, t[1] = r * n * o - s * h * a, t[2] = r * h * a + s * n * o, t[3] = r * h * o + s * n * a)
			}(this, t, t.order), this
		}
		fromAxisAngle(t, e) {
			return function(t, e, i) {
		...
		slerp(t, e) {
			return function(t, e, i, s) {
				let r, n, h, a, o, l = e[0],
					...
					m = i[2],
					f = i[3];
				n = l * g + u * p + c * m + d * f, n < 0 && (n = -n, g = -g, p = -p, m = -m, f = -f), 1 - n > 1e-6 ? (r = Math.acos(n), h = Math.sin(r), a = Math.sin((1 - s) * r) / h, o = Math.sin(s * r) / h) : (a = 1 - s, o = s), t[0] = a * l + o * g, t[1] = a * u + o * p, t[2] = a * c + o * m, t[3] = a * d + o * f
			}(this, this, t, e), this
		}
		fromArray(t, e = 0) {
	...
	function y(t, e, i) {
		let s = e[0],
			...
			E = i[2],
			M = i[3];
		return t[0] = x * s + b * a + E * c + M * m, t[1] = x * r + b * o + E * d + M * f, t[2] = x * n + b * l + E * g + M * w, t[3] = x * h + b * u + E * p + M * v, x = i[4], b = i[5], E = i[6], M = i[7], t[4] = x * s + b * a + E * c + M * m, t[5] = x * r + b * o + E * d + M * f, t[6] = x * n + b * l + E * g + M * w, t[7] = x * h + b * u + E * p + M * v, x = i[8], b = i[9], E = i[10], M = i[11], t[8] = x * s + b * a + E * c + M * m, t[9] = x * r + b * o + E * d + M * f, t[10] = x * n + b * l + E * g + M * w, t[11] = x * h + b * u + E * p + M * v, x = i[12], b = i[13], E = i[14], M = i[15], t[12] = x * s + b * a + E * c + M * m, t[13] = x * r + b * o + E * d + M * f, t[14] = x * n + b * l + E * g + M * w, t[15] = x * h + b * u + E * p + M * v, t
	}
	...
	const S = function() {
		...
		return function(e, i) {
			...
			let r = 1 / s[0],
				...
				f = a + c + m,
				w = 0;
			return f > 0 ? (w = 2 * Math.sqrt(f + 1), e[3] = .25 * w, e[0] = (d - p) / w, e[1] = (g - l) / w, e[2] = (o - u) / w) : a > c && a > m ? (w = 2 * Math.sqrt(1 + a - c - m), e[3] = (d - p) / w, e[0] = .25 * w, e[1] = (o + u) / w, e[2] = (g + l) / w) : c > m ? (w = 2 * Math.sqrt(1 + c - a - m), e[3] = (g - l) / w, e[0] = (o + u) / w, e[1] = .25 * w, e[2] = (d + p) / w) : (w = 2 * Math.sqrt(1 + m - a - c), e[3] = (o - u) / w, e[0] = (g + l) / w, e[1] = (d + p) / w, e[2] = .25 * w), e
		}
	}();
	class T extends Array {
		...
		set(t, e, i, s, r, n, h, a, o, l, u, c, d, g, p, m) {
			return t.length ? this.copy(t) : (function(t, e, i, s, r, n, h, a, o, l, u, c, d, g, p, m, f) {
				t[0] = e, t[1] = i, t[2] = s, t[3] = r, t[4] = n, t[5] = h, t[6] = a, t[7] = o, t[8] = l, t[9] = u, t[10] = c, t[11] = d, t[12] = g, t[13] = p, t[14] = m, t[15] = f
			}(this, t, e, i, s, r, n, h, a, o, l, u, c, d, g, p, m), this)
		}
		translate(t, e = this) {
			return function(t, e, i) {
				let s, r, n, h, a, o, l, u, c, d, g, p, m = i[0],
					f = i[1],
					w = i[2];
				e === t ? (t[12] = e[0] * m + e[4] * f + e[8] * w + e[12], t[13] = e[1] * m + e[5] * f + e[9] * w + e[13], t[14] = e[2] * m + e[6] * f + e[10] * w + e[14], t[15] = e[3] * m + e[7] * f + e[11] * w + e[15]) : (s = e[0], r = e[1], n = e[2], h = e[3], a = e[4], o = e[5], l = e[6], u = e[7], c = e[8], d = e[9], g = e[10], p = e[11], t[0] = s, t[1] = r, t[2] = n, t[3] = h, t[4] = a, t[5] = o, t[6] = l, t[7] = u, t[8] = c, t[9] = d, t[10] = g, t[11] = p, t[12] = s * m + a * f + c * w + e[12], t[13] = r * m + o * f + d * w + e[13], t[14] = n * m + l * f + g * w + e[14], t[15] = h * m + u * f + p * w + e[15])
			}(this, e, t), this
		}
		rotate(t, e, i = this) {
			return function(t, e, i, s) {
				let r, n, h, a, o, l, u, c, d, g, p, m, f, w, v, x, b, E, M, y, A, S, T, _, F = s[0],
					R = s[1],
					P = s[2],
					C = Math.hypot(F, R, P);
				Math.abs(C) < 1e-6 || (C = 1 / C, F *= C, R *= C, P *= C, r = Math.sin(i), n = Math.cos(i), h = 1 - n, a = e[0], o = e[1], l = e[2], u = e[3], c = e[4], d = e[5], g = e[6], p = e[7], m = e[8], f = e[9], w = e[10], v = e[11], x = F * F * h + n, b = R * F * h + P * r, E = P * F * h - R * r, M = F * R * h - P * r, y = R * R * h + n, A = P * R * h + F * r, S = F * P * h + R * r, T = R * P * h - F * r, _ = P * P * h + n, t[0] = a * x + c * b + m * E, t[1] = o * x + d * b + f * E, t[2] = l * x + g * b + w * E, t[3] = u * x + p * b + v * E, t[4] = a * M + c * y + m * A, t[5] = o * M + d * y + f * A, t[6] = l * M + g * y + w * A, t[7] = u * M + p * y + v * A, t[8] = a * S + c * T + m * _, t[9] = o * S + d * T + f * _, t[10] = l * S + g * T + w * _, t[11] = u * S + p * T + v * _, e !== t && (t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]))
			}(this, i, t, e), this
		}
		scale(t, e = this) {
			return function(t, e, i) {
		...
		fromPerspective({
			...
			return function(t, e, i, s, r) {
				let n = 1 / Math.tan(e / 2),
					h = 1 / (s - r);
				t[0] = n / i, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = n, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = (r + s) * h, t[11] = -1, t[12] = 0, t[13] = 0, t[14] = 2 * r * s * h, t[15] = 0
			}(this, t, e, i, s), this
		}
		fromOrthogonal({
			left: t,
			...
			return function(t, e, i, s, r, n, h) {
				let a = 1 / (e - i),
					o = 1 / (s - r),
					l = 1 / (n - h);
				t[0] = -2 * a, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = -2 * o, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 2 * l, t[11] = 0, t[12] = (e + i) * a, t[13] = (r + s) * o, t[14] = (h + n) * l, t[15] = 1
		...
		fromQuaternion(t) {
			return function(t, e) {
				let i = e[0],
					...
					f = n * a,
					w = n * o;
				t[0] = 1 - c - p, t[1] = u + w, t[2] = d - f, t[3] = 0, t[4] = u - w, t[5] = 1 - l - p, t[6] = g + m, t[7] = 0, t[8] = d + f, t[9] = g - m, t[10] = 1 - l - c, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
			}(this, t), this
		}
		setPosition(t) {
		...
		inverse(t = this) {
			return function(t, e) {
				...
				P && (P = 1 / P, t[0] = (a * R - o * F + l * _) * P, t[1] = (r * F - s * R - n * _) * P, t[2] = (m * y - f * M + w * E) * P, t[3] = (d * M - c * y - g * E) * P, t[4] = (o * T - h * R - l * S) * P, t[5] = (i * R - r * T + n * S) * P, t[6] = (f * b - p * y - w * x) * P, t[7] = (u * y - d * b + g * x) * P, t[8] = (h * F - a * T + l * A) * P, t[9] = (s * T - i * F - n * A) * P, t[10] = (p * M - m * b + w * v) * P, t[11] = (c * b - u * M - g * v) * P, t[12] = (a * S - h * _ - o * A) * P, t[13] = (i * _ - s * S + r * A) * P, t[14] = (m * x - p * E - f * v) * P, t[15] = (u * E - c * x + d * v) * P)
			}(this, t), this
		}
		compose(t, e, i) {
			return function(t, e, i, s) {
				let r = e[0],
					...
					E = s[1],
					M = s[2];
				t[0] = (1 - (p + f)) * b, t[1] = (d + x) * b, t[2] = (g - v) * b, t[3] = 0, t[4] = (d - x) * E, t[5] = (1 - (c + f)) * E, t[6] = (m + w) * E, t[7] = 0, t[8] = (g + v) * M, t[9] = (m - w) * M, t[10] = (1 - (c + p)) * M, t[11] = 0, t[12] = i[0], t[13] = i[1], t[14] = i[2], t[15] = 1
			}(this, t, e, i), this
		}
		getRotation(t) {
		...
		lookAt(t, e, i) {
			return function(t, e, i, s) {
				...
				let p = o * d - l * c,
					m = l * u - a * d,
					f = a * c - o * u;
				g = p * p + m * m + f * f, 0 === g && (l ? a += 1e-6 : o ? l += 1e-6 : o += 1e-6, p = o * d - l * c, m = l * u - a * d, f = a * c - o * u, g = p * p + m * m + f * f), g = 1 / Math.sqrt(g), p *= g, m *= g, f *= g, t[0] = p, t[1] = m, t[2] = f, t[3] = 0, t[4] = c * f - d * m, t[5] = d * p - u * f, t[6] = u * m - c * p, t[7] = 0, t[8] = u, t[9] = c, t[10] = d, t[11] = 0, t[12] = r, t[13] = n, t[14] = h, t[15] = 1
			}(this, t, e, i), this
		}
		determinant() {
			return function(t) {
				let e = t[0],
					...
					m = t[14],
					f = t[15];
				return (e * h - i * n) * (c * f - d * m) - (e * a - s * n) * (u * f - d * p) + (e * o - r * n) * (u * m - c * p) + (i * a - s * h) * (l * f - d * g) - (i * o - r * h) * (l * m - c * g) + (s * o - r * a) * (l * p - u * g)
			}(this)
		}
		fromArray(t, e = 0) {
	...
	class R {
		constructor() {
			this.parent = null, this.children = [], this.visible = !0, this.matrix = new T, this.worldMatrix = new T, this.matrixAutoUpdate = !0, this.position = new g, this.quaternion = new M, this.scale = new g(1), this.rotation = new F, this.up = new g(0, 1, 0), this.rotation.onChange = () => this.quaternion.fromEuler(this.rotation), this.quaternion.onChange = () => this.rotation.fromQuaternion(this.quaternion)
		}
		setParent(t, e = !0) {
	...
	class I extends R {
		constructor(t, {
			...
			super(), Object.assign(this, {
				...
				top: o,
				zoom: l
			}), this.projectionMatrix = new T, this.viewMatrix = new T, this.projectionViewMatrix = new T, this.worldPosition = new g, this.type = n || h ? "orthographic" : "perspective", "orthographic" === this.type ? this.orthographic() : this.perspective()
		}
		perspective({
			near: t = this.near,
			far: e = this.far,
		...
		orthographic({
			...
			return Object.assign(this, {
				...
				top: n,
				zoom: h
			}), i /= h, s /= h, r /= h, n /= h, this.projectionMatrix.fromOrthogonal({
				left: i,
				right: s,
				bottom: r,
				top: n,
	...
	class O {
		constructor(t, e = {}) {
			t.canvas || console.error("gl not passed as first argument to Geometry"), this.gl = t, this.attributes = e, this.id = D++, this.VAOs = {}, this.drawRange = {
				start: 0,
				count: 0
		...
		addAttribute(t, e) {
			if (this.attributes[t] = e, e.id = N++, e.size = e.size || 1, e.type = e.type || (e.data.constructor === Float32Array ? this.gl.FLOAT : e.data.constructor === Uint16Array ? this.gl.UNSIGNED_SHORT : this.gl.UNSIGNED_INT), e.target = "index" === t ? this.gl.ELEMENT_ARRAY_BUFFER : this.gl.ARRAY_BUFFER, e.normalized = e.normalized || !1, e.stride = e.stride || 0, e.offset = e.offset || 0, e.count = e.count || (e.stride ? e.data.byteLength / e.stride : e.data.length / e.size), e.divisor = e.instanced || 0, e.needsUpdate = !1, e.buffer || (e.buffer = this.gl.createBuffer(), this.updateAttribute(e)), e.divisor) {
	...
	class z extends O {
		constructor(t, {
			...
			z.buildPlane(u, c, d, g, e, i, 0, h, a), Object.assign(n, {
				position: {
					size: 3,
					data: u
				},
		...
		static buildPlane(t, e, i, s, r, n, h, a, o, l = 0, u = 1, c = 2, d = 1, g = -1, p = 0, m = 0) {
			...
			for (let x = 0; x <= o; x++) {
				...
				for (let n = 0; n <= a; n++, p++) {
					let v = n * w - r / 2;
					if (t[3 * p + l] = v * d, t[3 * p + u] = b * g, t[3 * p + c] = h / 2, e[3 * p + l] = 0, e[3 * p + u] = 0, e[3 * p + c] = h >= 0 ? 1 : -1, i[2 * p] = n / a, i[2 * p + 1] = 1 - x / o, x === o || n === a) continue;
					let E = f + n + x * (a + 1),
						M = f + n + (x + 1) * (a + 1),
						y = f + n + (x + 1) * (a + 1) + 1,
						A = f + n + x * (a + 1) + 1;
	...
	class j {
		constructor(t, {
			...
			this.gl = t, this.id = W++, this.image = e, this.target = i, this.type = s, this.format = r, this.internalFormat = n, this.minFilter = l, this.magFilter = u, this.wrapS = h, this.wrapT = a, this.generateMipmaps = o, this.premultiplyAlpha = c, this.unpackAlignment = d, this.flipY = g, this.anisotropy = Math.min(p, this.gl.renderer.parameters.maxAnisotropy), this.level = m, this.width = f, this.height = w, this.texture = this.gl.createTexture(), this.store = {
				image: null
		...
		update(t = 0) {
			...
			if ((e || this.glState.textureUnits[t] !== this.id) && (this.gl.renderer.activeTexture(t), this.bind()), e) {
				if (this.needsUpdate = !1, this.flipY !== this.glState.flipY && (this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL, this.flipY), this.glState.flipY = this.flipY), this.premultiplyAlpha !== this.glState.premultiplyAlpha && (this.gl.pixelStorei(this.gl.UNPACK_PREMULTIPLY_ALPHA_WEBGL, this.premultiplyAlpha), this.glState.premultiplyAlpha = this.premultiplyAlpha), this.unpackAlignment !== this.glState.unpackAlignment && (this.gl.pixelStorei(this.gl.UNPACK_ALIGNMENT, this.unpackAlignment), this.glState.unpackAlignment = this.unpackAlignment), this.minFilter !== this.state.minFilter && (this.gl.texParameteri(this.target, this.gl.TEXTURE_MIN_FILTER, this.minFilter), this.state.minFilter = this.minFilter), this.magFilter !== this.state.magFilter && (this.gl.texParameteri(this.target, this.gl.TEXTURE_MAG_FILTER, this.magFilter), this.state.magFilter = this.magFilter), this.wrapS !== this.state.wrapS && (this.gl.texParameteri(this.target, this.gl.TEXTURE_WRAP_S, this.wrapS), this.state.wrapS = this.wrapS), this.wrapT !== this.state.wrapT && (this.gl.texParameteri(this.target, this.gl.TEXTURE_WRAP_T, this.wrapT), this.state.wrapT = this.wrapT), this.anisotropy && this.anisotropy !== this.state.anisotropy && (this.gl.texParameterf(this.target, this.gl.renderer.getExtension("EXT_texture_filter_anisotropic").TEXTURE_MAX_ANISOTROPY_EXT, this.anisotropy), this.state.anisotropy = this.anisotropy), this.image) {
					...
					this.generateMipmaps && (this.gl.renderer.isWebgl2 || V(this.image.width) && V(this.image.height) ? this.gl.generateMipmap(this.target) : (this.generateMipmaps = !1, this.wrapS = this.wrapT = this.gl.CLAMP_TO_EDGE, this.minFilter = this.gl.LINEAR)), this.onUpdate && this.onUpdate()
				} else if (this.target === this.gl.TEXTURE_CUBE_MAP)
					for (let t = 0; t < 6; t++) this.gl.texImage2D(this.gl.TEXTURE_CUBE_MAP_POSITIVE_X + t, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, Y);
				else this.width ? this.gl.texImage2D(this.target, this.level, this.internalFormat, this.width, this.height, 0, this.format, this.type, null) : this.gl.texImage2D(this.target, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, Y);
	...
	class Z {
		constructor(t, {
			...
			t.canvas || console.error("gl not passed as fist argument to Program"), this.gl = t, this.uniforms = s, this.id = k++, e || console.warn("vertex shader not supplied"), i || console.warn("fragment shader not supplied"), this.transparent = r, this.cullFace = n, this.frontFace = h, this.depthTest = a, this.depthWrite = o, this.depthFunc = l, this.blendFunc = {}, this.blendEquation = {}, this.transparent && !this.blendFunc.src && (this.gl.renderer.premultipliedAlpha ? this.setBlendFunc(this.gl.ONE, this.gl.ONE_MINUS_SRC_ALPHA) : this.setBlendFunc(this.gl.SRC_ALPHA, this.gl.ONE_MINUS_SRC_ALPHA));
			...
			if (t.shaderSource(c, i), t.compileShader(c), "" !== t.getShaderInfoLog(c) && console.warn(`${t.getShaderInfoLog(c)}\nFragment Shader\n${Q(i)}`), this.program = t.createProgram(), t.attachShader(this.program, u), t.attachShader(this.program, c), t.linkProgram(this.program), !t.getProgramParameter(this.program, t.LINK_STATUS)) return console.warn(t.getProgramInfoLog(this.program));
		...
		use({
			...
			this.gl.renderer.currentProgram === this.id || (this.gl.useProgram(this.program), this.gl.renderer.currentProgram = this.id), this.uniformLocations.forEach((t, i) => {
				let s = i.uniformName,
					r = this.uniforms[s];
				if (i.isStruct && (r = r[i.structProperty], s += "." + i.structProperty), i.isStructArray && (r = r[i.structIndex][i.structProperty], s += `[${i.structIndex}].${i.structProperty}`), !r) return J(`Active uniform ${s} has not been supplied`);
	...
	function tt(t, e, i) {
		let s = e[0],
			...
			x = i[7],
			b = i[8];
		return t[0] = d * s + g * h + p * l, t[1] = d * r + g * a + p * u, t[2] = d * n + g * o + p * c, t[3] = m * s + f * h + w * l, t[4] = m * r + f * a + w * u, t[5] = m * n + f * o + w * c, t[6] = v * s + x * h + b * l, t[7] = v * r + x * a + b * u, t[8] = v * n + x * o + b * c, t
	}
	class et extends Array {
		...
		set(t, e, i, s, r, n, h, a, o) {
			return t.length ? this.copy(t) : (function(t, e, i, s, r, n, h, a, o, l) {
				t[0] = e, t[1] = i, t[2] = s, t[3] = r, t[4] = n, t[5] = h, t[6] = a, t[7] = o, t[8] = l
			}(this, t, e, i, s, r, n, h, a, o), this)
		}
		translate(t, e = this) {
			return function(t, e, i) {
				let s = e[0],
		...
		inverse(t = this) {
			return function(t, e) {
				let i = e[0],
					...
					g = l * n - h * o,
					p = i * c + s * d + r * g;
				p && (p = 1 / p, t[0] = c * p, t[1] = (-u * s + r * l) * p, t[2] = (a * s - r * h) * p, t[3] = d * p, t[4] = (u * i - r * o) * p, t[5] = (-a * i + r * n) * p, t[6] = g * p, t[7] = (-l * i + s * o) * p, t[8] = (h * i - s * n) * p)
			}(this, t), this
		}
		getNormalMatrix(t) {
			return function(t, e) {
				let i = e[0],
					...
					R = d * w - g * f,
					P = v * R - x * F + b * _ + E * T - M * S + y * A;
				P && (P = 1 / P, t[0] = (a * R - o * F + l * _) * P, t[1] = (o * T - h * R - l * S) * P, t[2] = (h * F - a * T + l * A) * P, t[3] = (r * F - s * R - n * _) * P, t[4] = (i * R - r * T + n * S) * P, t[5] = (s * T - i * F - n * A) * P, t[6] = (m * y - f * M + w * E) * P, t[7] = (f * b - p * y - w * x) * P, t[8] = (p * M - m * b + w * v) * P)
			}(this, t), this
		}
	}
	let it = 0;
	class st extends R {
		constructor(t, {
			...
			super(), t.canvas || console.error("gl not passed as first argument to Mesh"), this.gl = t, this.id = it++, this.geometry = e, this.program = i, this.mode = s, this.frustumCulled = r, this.renderOrder = n, this.modelViewMatrix = new T, this.normalMatrix = new et, this.beforeRenderCallbacks = [], this.afterRenderCallbacks = []
		}
		onBeforeRender(t) {
	...
	class rt {
		constructor(t, {
			...
			const w = [];
			for (let s = 0; s < r; s++) this.textures.push(new j(t, {
				width: e,
				height: i,
				wrapS: o,
				wrapT: l,
				...
				flipY: !1,
				generateMipmaps: !1
			})), this.textures[s].update(), this.gl.framebufferTexture2D(this.target, this.gl.COLOR_ATTACHMENT0 + s, this.gl.TEXTURE_2D, this.textures[s].texture, 0), w.push(this.gl.COLOR_ATTACHMENT0 + s);
			w.length > 1 && this.gl.renderer.drawBuffers(w), this.texture = this.textures[0], a && (this.gl.renderer.isWebgl2 || this.gl.renderer.getExtension("WEBGL_depth_texture")) ? (this.depthTexture = new j(t, {
				width: e,
				height: i,
	...
	class ht {
		constructor(t, {
			...
			this.gl = t, this.options = {
				...
				minFilter: h,
				magFilter: a
			}, this.passes = [], this.geometry = o, this.uniform = {
				value: null
			}, this.targetOnly = l;
			const u = this.fbo = {
				read: null,
		...
		resize({
			...
			i && (this.dpr = i), t && (this.width = t, this.height = e || t), i = this.dpr || this.gl.renderer.dpr, t = (this.width || this.gl.renderer.width) * i, e = (this.height || this.gl.renderer.height) * i, this.options.width = t, this.options.height = e, this.fbo.read = new rt(this.gl, this.options), this.fbo.write = new rt(this.gl, this.options)
		}
		render({
			scene: t,
			camera: e,
	...
	new([class {
		...
		createGeometry() {
			this.planeGeometry = new z(this.gl, {
				heightSegments: 10
			})
		}
		createMedias() {
			this.mediasElements = document.querySelectorAll(".demo-1__gallery__figure"), this.medias = Array.from(this.mediasElements).map(t => new class {
				constructor({
					element: t,
					geometry: e,
					gl: i,
					...
					this.element = t, this.image = this.element.querySelector("img"), this.extra = 0, this.height = s, this.geometry = e, this.gl = i, this.scene = r, this.screen = n, this.viewport = h, this.createMesh(), this.createBounds(), this.onResize()
				}
				createMesh() {
					const t = new Image,
						e = new j(this.gl, {
					...
					t.src = this.image.src, t.onload = s => {
				...
				update(t, e) {
					...
					this.isBefore = this.plane.position.y + i < -s, this.isAfter = this.plane.position.y - i > s, "up" === e && this.isBefore && (this.extra -= this.height, this.isBefore = !1, this.isAfter = !1), "down" === e && this.isAfter && (this.extra += this.height, this.isBefore = !1, this.isAfter = !1), this.plane.program.uniforms.uStrength.value = (t.current - t.last) / this.screen.width * 10
				}
				onResize(t) {
					if (this.extra = 0, t) {
						const {
		...
		onWheel(t) {
			const e = X()(t).pixelY;
			this.scroll.target += .5 * e
		}
		onResize() {
			this.screen = {
				height: window.innerHeight,
				width: window.innerWidth
			}, this.renderer.setSize(this.screen.width, this.screen.height), this.camera.perspective({
			...
			this.viewport = {
				height: e,
				width: i
			}, this.galleryBounds = this.gallery.getBoundingClientRect(), this.galleryHeight = this.viewport.height * this.galleryBounds.height / this.screen.height, this.medias && this.medias.forEach(t => t.onResize({
				height: this.galleryHeight,
				screen: this.screen,
				viewport: this.viewport
			}))
		...
		update() {
			this.scroll.target += this.speed, this.scroll.current = q(this.scroll.current, this.scroll.target, this.scroll.ease), this.scroll.current > this.scroll.last ? (this.direction = "down", this.speed = 2) : this.scroll.current < this.scroll.last && (this.direction = "up", this.speed = -2), this.medias && this.medias.forEach(t => t.update(this.scroll, this.direction)), this.renderer.render({
				scene: this.scene,
				camera: this.camera
		...
		constructor() {
			this.scroll = {
				...
				target: 0,
				last: 0
			}, this.speed = 2, this.createRenderer(), this.createCamera(), this.createScene(), this.createGallery(), this.createPost(), this.onResize(), this.createGeometry(), this.createMedias(), this.update(), this.addEventListeners()
		}
		createGallery() {
		...
		createPost() {
			this.post = new ht(this.gl), this.pass = this.post.addPass({
		...
		createMedias() {
			this.mediasElements = document.querySelectorAll(".demo-2__gallery__figure"), this.medias = Array.from(this.mediasElements).map(t => new class {
				constructor({
					element: t,
					geometry: e,
					gl: i,
					...
					this.element = t, this.image = this.element.querySelector("img"), this.extra = 0, this.geometry = e, this.gl = i, this.scene = s, this.screen = r, this.viewport = n, this.width = h, this.createMesh(), this.createBounds(), this.onResize()
				}
				createMesh() {
					const t = new Image,
						e = new j(this.gl, {
				...
				update(t, e) {
					...
					this.isBefore = this.plane.position.x + i < -s, this.isAfter = this.plane.position.x - i > s, "down" === e && this.isBefore && (this.extra -= this.width, this.isBefore = !1, this.isAfter = !1), "up" === e && this.isAfter && (this.extra += this.width, this.isBefore = !1, this.isAfter = !1), this.plane.program.uniforms.uStrength.value = (t.current - t.last) / this.screen.width * 5
				}
				onResize(t) {
					if (this.extra = 0, t) {
						const {
		...
		onResize() {
			...
			this.viewport = {
				height: e,
				width: i
			}, this.post.resize(), this.resolution.value.set(this.gl.canvas.width, this.gl.canvas.height), this.galleryBounds = this.gallery.getBoundingClientRect(), this.galleryWidth = this.viewport.width * this.galleryBounds.width / this.screen.width, this.medias && this.medias.forEach(t => t.onResize({
				screen: this.screen,
				viewport: this.viewport,
				width: this.galleryWidth
			}))
		...
		update() {
			this.scroll.target += this.speed, this.scroll.current = q(this.scroll.current, this.scroll.target, this.scroll.ease), this.scroll.current > this.scroll.last ? (this.direction = "down", this.speed = 2) : this.scroll.current < this.scroll.last && (this.direction = "up", this.speed = -2), this.medias && this.medias.forEach(t => t.update(this.scroll, this.direction)), this.pass.uniforms.uStrength.value = (this.scroll.current - this.scroll.last) / this.screen.width * .5, this.post.render({
				scene: this.scene,
				camera: this.camera
			}), this.scroll.last = this.scroll.current, window.requestAnimationFrame(this.update.bind(this))
		}
	...
	}][document.body.getAttribute("data-id")]), document.documentElement.classList.remove("no-js"), document.documentElement.classList.add("js");
	const mt = document.querySelectorAll('img:not([src*="https://tympanus.net/codrops/wp-content/banners/"])');
	let ft = 0;
	Array.from(mt).forEach(t => {
		const e = new Image;
		e.src = t.src, e.onload = t => {
